...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'register<N extends Extract<keyof LocaleNamespaceMap, string>>( ns: N, dicts: { en: LocaleDictOf<N> } & Partial<Record<Exclude<BuiltInLocaleId, \'en\'>, Partial<LocaleDictOf<N>>>>, ): () => void',
        ...
        parameters: [{ name: 'ns', description: 'a namespace merged into LocaleNamespaceMap.' }, { name: 'dicts', description: 'English dictionary and optional partial built-in translations.' }],
