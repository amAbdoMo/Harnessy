...
/** Settings operations needed by the legacy projection. */
export interface SubagentMigrationSettings {
  /** @returns every active profile entry exposed by the settings form service. */
  describe(): SettingsDescriptor[]
  /** @param namespace Profile entry id. @param section Replacement volatile Config values. */
...
export async function migrateStoredSubagentConfiguration(
  ctx: Context,
  settings: SubagentMigrationSettings,
): Promise<void> {
