 ...
 * source: {@link SubagentDefinition} is what is stored, and
...
/** Per-field source of one resolved definition, so an editor can offer a reset. */
 ...
 * delegation would actually run with, plus the source that tells an editor
