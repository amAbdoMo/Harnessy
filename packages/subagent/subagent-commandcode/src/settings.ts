...
/** Fields shared by the legacy profile import and the delegation document parser. */
export const CommandCodeDelegationFields = {
...
export const CommandCodeDelegationSchema: z<CommandCodeDelegationSettings> = z.object(CommandCodeDelegationFields)
 ...
 * @returns the resolved lanes with their per-field override source.
 */
