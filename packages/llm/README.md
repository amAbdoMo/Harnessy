...
| [`model-capabilities/`](model-capabilities/README.md) | Resolves provider-aware reasoning-effort metadata from public model databases, and reports model-id-only claims as suggestions | registers on `ctx.llm` |
