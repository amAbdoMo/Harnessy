...
/**
 * The source of one authoritative match.
 ...
 * @returns the source a consumer records beside the capability.
 */
function sourceOf(
 ...
 * @param modelId - the resolved model id.
 * @param catalog - the loaded catalog that answered.
 * @returns the resolved capability, source included.
 */
function resolvedFrom(
  ...
  return {
    ...
    source: sourceOf(match, request, modelId, catalog),
  }
}
