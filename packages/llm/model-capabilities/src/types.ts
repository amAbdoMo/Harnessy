 ...
 * capability populated today, and {@link ModelCapabilitySource.capability}
...
export interface PublicCatalog {
   ...
   * fixture has no fetch. It travels into source so a caller can answer how
...
export interface ModelCapabilitySource {
  /** Capability this source describes; the discriminator later capabilities reuse. */
...
export interface ResolvedPublicCapability {
  ...
  /** Capability name; the same discriminator {@link ModelCapabilitySource} carries. */
  readonly capability: 'reasoning-efforts'
...
/**
 * One configured model's capability source, as a Client reads it.
 *
