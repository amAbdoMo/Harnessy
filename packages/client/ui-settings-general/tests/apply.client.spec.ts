...
describe('ui-settings-general apply', () => {
  ...
  it('registers the English settings dictionary and frees the seats on teardown', async () => {
    const b = await bench()
    declare(b.slots)
  ...
  it('the English nav label thunk resolves without re-registration', async () => {
    const b = await bench()
    declare(b.slots)
