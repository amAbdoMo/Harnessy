...
export const zh = {
  ...
  'count.working.one': '{count} 个运行中',
  'count.working.other': '{count} 个运行中',
  'count.done.one': '{count} 个已完成',
  'count.done.other': '{count} 个已完成',
  'count.summary': '{working} 个运行中，{done} 个已完成',
  'completed.label': '{count} 个已完成',
  'completed.toggle': '显示或隐藏 {count} 个已完成的子智能体',
...
export const en: Record<SubagentKey, string> = {
  ...
  'count.working.one': '{count} working',
  'count.working.other': '{count} working',
  'count.done.one': '{count} done',
  'count.done.other': '{count} done',
  'count.summary': '{working} working, {done} done',
  'completed.label': '{count} done',
  'completed.toggle': 'Show or hide {count} completed subagents',
