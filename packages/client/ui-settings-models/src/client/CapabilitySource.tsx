/**
 * One model row's reasoning source, as the Models page shows it.
 *
 ...
 * relying on styling.
 *
 * @module @deepseek-ai/dsh-client-ui-settings-models/CapabilitySource
 */
...
import type { CapabilitySourceState } from './capability.ts'
...
/** Props of {@link CapabilitySource}. */
export interface CapabilitySourceProps {
...
/**
 * Render one row's source block, or nothing when there is nothing to say.
 * @param props - the reduced state, the clock, and section copy.
 * @returns the block, or null.
 */
export function CapabilitySource({ state, now, t }: CapabilitySourceProps): ReactNode {
