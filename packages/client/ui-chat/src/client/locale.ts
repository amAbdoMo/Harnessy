...
export const zh = {
  ...
  'changes.title': '文件更改',
  'changes.summary': '{count} 个文件已更改',
  'changes.list': '本轮更改的文件',
  'changes.code': '代码差异',
  'changes.wrap': '自动换行',
  'changes.unwrap': '取消自动换行',
  'changes.copy': '复制差异',
  'changes.copied': '已复制',
  'changes.collapse': '收起差异',
  'changes.expand': '展开另外 {count} 行',
  'activity.think': '思考',
  'activity.read': '读取文件',
  'activity.search': '搜索',
  'activity.command': '运行命令',
  'activity.edit': '编辑文件',
  'activity.mcp': '使用 MCP',
  'activity.delegate': '委派',
  'activity.tool': '使用工具',
  'activity.needsAttention': '需要处理',
  'activity.separator': '、',
...
export const en = {
  ...
  'activity.think': 'Thought',
  'activity.read': 'Read files',
  'activity.search': 'Searched',
  'activity.command': 'Ran commands',
  'activity.edit': 'Edited files',
  'activity.mcp': 'Used MCP',
  'activity.delegate': 'Delegated',
  'activity.tool': 'Used tools',
  ...
  'changes.list': 'Files changed in this turn',
  'changes.code': 'Code diff',
  'changes.wrap': 'Wrap lines',
  'changes.unwrap': 'Keep source columns',
  'changes.copy': 'Copy diff',
  'changes.copied': 'Copied',
  'changes.collapse': 'Collapse diff',
  'changes.expand': 'Expand {count} more lines',
