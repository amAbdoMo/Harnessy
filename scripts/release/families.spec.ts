...
describe('release families', () => {
  it('excludes private experimental packages from the dsh release', () => {
    ...
    expect(names).not.toContain('@deepseek-ai/dsh-experimental-agent-team')
    expect(names).toContain('@deepseek-ai/dsh-custom-harness')
    expect(names).toContain('@deepseek-ai/dsh-client-ui-brand-custom-harness')
    expect(names).toContain('@deepseek-ai/dsh-client-ui-workspace-brief')
    expect(names).toContain('@deepseek-ai/dsh-workspace-brief')
  })
