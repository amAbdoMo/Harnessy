...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  mcpManagerController: 'settings.md',
  modelCapabilitiesInspector: 'llm-streaming.md',
  ...
  commandCodeController: 'subagent.md',
  subagentRosterController: 'subagent.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  modelCapabilities: 'optional catalog store mounted by the model-capabilities plugin — packages/llm/model-capabilities/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LlmModelCapability: 'llm-streaming.md',
  LlmModelCapabilityLookup: 'llm-streaming.md',
  ModelCapabilityInspectionView: 'llm-streaming.md',
  ...
  OpenAIAccountState: 'settings.md',
  OpenAIAccountSignInResult: 'settings.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  McpServerInput: 'MCP manager write contract is owned by packages/api/settings-controller/src/types.ts',
  ...
  CommandCodeCatalog: 'service-local catalog contract is owned by packages/subagent/subagent-commandcode/README.md',
  CommandCodeDelegationView: 'service-local resolved-lane contract is owned by packages/subagent/subagent-commandcode/README.md',
  CommandCodeHealth: 'service-local CLI-state contract is owned by packages/subagent/subagent-commandcode/README.md',
  SubagentAutomaticRouting: 'service-local routing-authority contract is owned by packages/subagent/subagent-roster/README.md',
  SubagentStoredRoster: 'service-local stored-document contract is owned by packages/subagent/subagent-roster/README.md',
  SubagentWorkspaceRoster: 'service-local resolved-roster contract is owned by packages/subagent/subagent-roster/README.md',
