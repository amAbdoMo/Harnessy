...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-subagent-commandcode -->
<a id="deepseek-aidsh-subagent-commandcode"></a>

## `@deepseek-ai/dsh-subagent-commandcode`

- `inject`: `typert` · `tools` · `subprocess`
- `refs`: `Volatile` (`@deepseek-ai/cordis`)
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-subagent-commandcode -->
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-subagent-roster -->
<a id="deepseek-aidsh-subagent-roster"></a>

## `@deepseek-ai/dsh-subagent-roster`

- `inject`: `tools` · `subagents` · `agents` · `sessionProjections`
- `refs`: [`AllowedModelRoute`](subsystems/subagent.zh.md) · `SubagentAccess` (`@deepseek-ai/dsh-subagent/client`) · [`ToolRestriction`](subsystems/tools.zh.md) · `Volatile` (`@deepseek-ai/cordis`)
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-subagent-roster -->
...
| `@deepseek-ai/dsh-workspace-brief` | `commands` · `fs` · `sandboxPolicy` · `shell` · `workspaceRegistry` | [`packages/workspace/workspace-brief/src/index.ts`](../packages/workspace/workspace-brief/src/index.ts) |
