...
Source: [`packages/api/settings-controller/src/index.ts:42`](../packages/api/settings-controller/src/index.ts)
...
Requires: `typert` · `settings` · `tools` · `subprocess`
...
- `@deepseek-ai/dsh-subagent-roster` — requires `tools` · `subagents` · `agents` · `sessionProjections` ([`packages/subagent/subagent-roster/src/index.ts`](../packages/subagent/subagent-roster/src/index.ts))
