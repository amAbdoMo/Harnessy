...
- `refs`: [`AllowedModelRoute`](subsystems/subagent.md) · `SubagentAccess` (`@deepseek-ai/dsh-subagent/client`) · [`ToolRestriction`](subsystems/tools.md) · `Volatile` (`@deepseek-ai/cordis`)
