...
export const en = {
  ...
  startupFailed: 'Custom Harness could not start',
  ...
  updateTitle: 'Custom Harness Update',
  updateAvailable: 'An update is available',
  updateDetail: 'Custom Harness {version}\n\nThis release includes its matching Harness runtime. The application will restart after installation.',
  installAndRestart: 'Install and Restart',
  later: 'Later',
  updateFailedTitle: 'Update Failed',
  pluginManagerTitle: 'Desktop Plugins',
  pluginWindowTitle: 'Custom Harness — Desktop Plugins',
...
export const zh = {
  application: '应用',
  startupFailed: 'Custom Harness 无法启动',
  pluginsMenu: '桌面插件…',
  ...
  updateTitle: 'Custom Harness 更新',
  updateAvailable: '发现可用更新',
  updateDetail: 'Custom Harness {version}\n\n新版本绑定匹配的 Harness 运行时，安装后将重新启动。',
  installAndRestart: '安装并重启',
  later: '稍后',
  updateFailedTitle: '更新失败',
  pluginManagerTitle: '桌面插件',
  pluginWindowTitle: 'Custom Harness — 桌面插件',
